...
# 执行自定义训练过程
def mnist_fnn_linear_attack_train(model, optimizer, num_weight, gama, total_epoch):
    ...
    test_accuracy_name = 'mnist_linear//linear//mnist_fnn_linear_attack' + str(
        num_weight) + '_test_accuracy_' + str(gama) + '_' + str(total_epoch)
    mape_name = 'mnist_linear//linear//mnist_fnn_linear_attack' + str(num_weight) + '_mape_' + str(
        gama) + '_' + str(total_epoch)
    data_name = 'mnist_linear//linear//mnist_fnn_linear_attack' + str(num_weight) + '_stolen_data_' + str(
        gama) + '_' + str(total_epoch)
